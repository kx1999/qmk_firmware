...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //+-------+-------+-------+-------+-------+-------+                       +-------+-------+-------+-------+-------+-------+
     KC_F12 ,KC_F1  ,KC_F2  ,KC_F3  ,KC_F4  ,KC_F5  ,                        KC_F6  ,KC_F7  ,KC_F8  ,KC_F9  ,KC_F10 ,KC_F11 ,
  //|-------+-------+-------+-------+-------+-------|						|-------+-------+-------+-------+-------+-------|
     _______,_______,_______,KC_UP  ,_______,_______,                        _______,KC_MPRV,_______,KC_MNXT,KC_VOLU,KC_SUP ,
  //|-------+-------+-------+-------+-------+-------|						|-------+-------+-------+-------+-------+-------|
     _______,_______,KC_LEFT,KC_DOWN,KC_RGHT,_______,                        KC_LEFT,KC_DOWN,KC_UP  ,KC_RGHT,KC_VOLD,KC_SDN ,
  //|-------+-------+-------+-------+-------+-------|						|-------+-------+-------+-------+-------+-------|
