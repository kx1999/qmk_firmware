...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|-------+-------+-------+-------+-------+-------|						|-------+-------+-------+-------+-------+-------|
     KC_LCTL,_______,_______,_______,_______,_______,                        _______,KC_LEFT,KC_DOWN,KC_RGHT,_______,_______,
  //|-------+-------+-------+-------+-------+-------|						|-------+-------+-------+-------+-------+-------|
  ...
  //                            +-------+-------+                               +-------+-------+
                                 _______,KC_ENT ,                                _______,KC_GTST,
  //                                |-------+-------|                       |-------+-------|
  ...
  //|-------+-------+-------+-------+-------+-------|						|-------+-------+-------+-------+-------+-------|
     _______,KC_HOME,MS_WHLU,KC_BTAB,KC_FTAB,KC_PGUP,                        _______,_______,_______,_______,_______,_______,
  //|-------+-------+-------+-------+-------+-------|						|-------+-------+-------+-------+-------+-------|
     _______,KC_END ,MS_WHLD,KC_BACK,KC_FRWD,KC_PGDN,                        _______,_______,_______,_______,_______,_______,
  //+-------+-------+-------+-------+-------+-------+                       +-------+-------+-------+-------+-------+-------+
                     _______,_______,                                                        _______,_______,
  //                +-------+-------+                                                       +-------+-------+
  //                            +-------+-------+                               +-------+-------+
                                 _______,_______,                                _______,_______,
  //                            +-------+-------+                               +-------+-------+
                                 _______,_______,                                _______,KC_GTST,
  //                                |-------+-------|                       |-------+-------|
                                     _______,_______,                        _______,_______
  //                                +-------+-------+                       +-------+-------+
  ),
  ...
  //|-------+-------+-------+-------+-------+-------|						|-------+-------+-------+-------+-------+-------|
     _______,_______,_______,_______,_______,_______,                        _______,KC_MPRV,_______,KC_MNXT,KC_PGUP,_______,
  //|-------+-------+-------+-------+-------+-------|						|-------+-------+-------+-------+-------+-------|
     _______,_______,_______,_______,_______,_______,                        KC_LEFT,KC_DOWN,KC_UP  ,KC_RGHT,KC_PGDN,_______,
  //|-------+-------+-------+-------+-------+-------|						|-------+-------+-------+-------+-------+-------|
     _______,_______,_______,_______,_______,_______,                        _______,KC_HOME,KC_END ,KC_INS ,KC_LCA0,KC_LCA9,
  //+-------+-------+-------+-------+-------+-------+                       +-------+-------+-------+-------+-------+-------+
